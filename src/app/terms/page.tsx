      ...
      <Section className="pt-0">
        <Container>
          <div className="max-w-3xl mx-auto prose prose-slate">
            ...
            <p>You agree to use StackPilot only for lawful purposes and in accordance with these terms. You may not:</p>
            <ul>
            ...
            <p>All content on StackPilot, including tool reviews, comparisons, ratings, and recommendations, is provided for informational purposes only. We strive for accuracy through our editorial process (detailed on our <a href="/methodology">Methodology page</a>), but make no warranties about the completeness, timeliness, or reliability of our content.</p>
            ...
            <p>StackPilot may earn affiliate commissions from some of the products and services we review. When you click an affiliate link on our site and make a purchase, we may receive a commission at no additional cost to you. This does not affect our editorial independence — we do not accept payment for positive reviews, and our ratings are determined solely by our editorial process as described on our <a href="/methodology">Methodology page</a>.</p>
            ...
            <p>If you submit comments, feedback, or other content to StackPilot, you grant us a non-exclusive, royalty-free license to use, display, and distribute that content in connection with the Service. You represent that your submissions do not infringe on any third-party rights.</p>

            <h2>Intellectual Property</h2>
            <p>All content, trademarks, logos, and intellectual property on StackPilot — including but not limited to text, graphics, ratings methodologies, and page layouts — are owned by or licensed to us. You may not reproduce, distribute, modify, or create derivative works without our express written permission. Short excerpts with proper attribution (linking back to the original StackPilot page) for commentary or criticism are permitted under fair use.</p>

            <h2>Disclaimer of Warranties</h2>
            <p>StackPilot is provided "as is" and "as available" without warranties of any kind, either express or implied. We do not guarantee that the Service will be uninterrupted, secure, or error-free, or that defects will be corrected. We make no representation that any tool or service reviewed on StackPilot is suitable for your specific needs.</p>

            <h2>Limitation of Liability</h2>
            <p>To the maximum extent permitted by law, StackPilot and its operators shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or business opportunities, arising from your use of or inability to use the Service. Our total liability for any claim arising from these terms shall not exceed $100 USD.</p>
            ...
            <h2>Contact</h2>
            <p>For questions about these Terms of Service, contact us at <strong>legal@stackpilot.ai</strong>.</p>
          </div>
        </Container>
      </Section>
    </>
