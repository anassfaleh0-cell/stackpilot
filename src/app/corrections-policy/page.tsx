...
export const metadata = createMetadata({
  ...
  description: "PilotStack's policy for correcting errors in published content. We are committed to transparency and accuracy in all our software research.",
        ...
        <Container>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <ol>
                <li><strong>Receipt:</strong> Errors may be identified by our team or reported by readers through our <a href="/contact">contact form</a>, email to corrections@pilotstack.online, or direct messages on social media.</li>
              ...
              <p>We maintain a log of all significant and critical corrections. Readers can request this log by emailing <strong>corrections@pilotstack.online</strong>.</p>

              <h2>Appeals</h2>
              <p>If you believe a correction was made in error or insufficiently addressed, you may appeal by emailing <strong>editorial@pilotstack.online</strong>. Appeals are reviewed by our editorial director, who is not involved in day-to-day correction decisions.</p>
              ...
              <p className="text-sm text-muted-foreground-foreground mt-8">Report an error: <strong>corrections@pilotstack.online</strong></p>
            </div>
          </div>
        </Container>
      </Section>
