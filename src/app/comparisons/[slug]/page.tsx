...
import { BreadcrumbSchema, FAQSchema, ReviewSchema, SoftwareSchema, softwareApp, WebPageSchema, ArticleSchema } from "@/components/seo/json-ld"
...
export default async function ComparisonPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      ...
      {review1 && <ReviewSchema name={review1.name} description={review1.description} rating={review1.rating} url={`${site.url}/reviews/${review1.slug}`} />}
      {review2 && <ReviewSchema name={review2.name} description={review2.description} rating={review2.rating} url={`${site.url}/reviews/${review2.slug}`} />}
